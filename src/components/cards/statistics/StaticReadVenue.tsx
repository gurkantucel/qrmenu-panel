    ...
    <MainCard contentSX={{ p: 2.25 }}>
      <Stack spacing={0.5}>
        <Grid container justifyContent={"space-between"}>
          ...
          <Select value={selectData.currency_code} onChange={(event) => {
        ...
        <Grid container alignItems="center">
          <Grid item>
            <Typography variant="h4" color="inherit">
              {new Intl.NumberFormat('tr-TR', { style: 'currency', currency: selectData.currency_code }).format(Number(selectData.amount))}
            </Typography>
          </Grid>
      ...
      <Box sx={{ pt: 2.25 }}>
        <Typography variant="body1" color="text.secondary">
          ...
          <Typography variant="caption" sx={{ color: `${color || 'primary'}.main` }}>
            {new Intl.NumberFormat('tr-TR', { style: 'currency', currency: selectData.currency_code }).format(Number(selectData.this_month))}
          </Typography>
        </Typography>
      </Box>
    </MainCard>
