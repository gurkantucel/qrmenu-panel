...
import { useGetAppointmentListQuery } from 'reduxt/features/branch/appointment-api';
import { AppointmentListData } from 'reduxt/features/branch/models/branch-model';
